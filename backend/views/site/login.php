...
<div class="login-box">
    <div class="login-logo">
        <a href="#"><b><?= Yii::t('app', 'Backend Admin System')?></b></a>
    </div>
    <!-- /.login-logo -->
...
<!--            <p>- OR -</p>-->
            <a href="#" class="btn btn-block btn-social btn-weixin btn-flat"><i class="fa fa-weixin"></i>
                <?= Yii::t('app', 'Sign in using Weixin')?>
            </a>
        </div>
        <!-- /.social-auth-links -->
